...
@Composable
fun SelectGridSizeButton(gridSizeOption: String, size: Float, onClick: () -> Unit){
    Button(
        onClick = onClick,
        shape = CircleShape,
        modifier = Modifier
...
@Composable
fun HorizontalGridSizeScreen(gridSizeOptions: List<Pair<String, Int>>, onNextButtonClicked: (Int) -> Unit) {
    Surface (
        modifier = Modifier
            .fillMaxSize(1f),
        color = Color(0xFF101111)
